...
class ViewController: UIViewController {
    ...
    @IBAction func loginButtonTouchUpInside(_ sender: AnyObject) {
        ...
        if mode == .signup {
            ...
            if self.loginEmailInputView.textFieldView.text == "" || self.loginPasswordInputView.textFieldView.text == "" {
                ...
                Auth.auth().signIn(withEmail: self.loginEmailInputView.textFieldView.text!, password: self.loginPasswordInputView.textFieldView.text!) { (user, error) in
                    ...
                    if error == nil {
                        ...
                        let vc = self.storyboard?.instantiateViewController(withIdentifier: "ggwp") as! MainViewController
    ...
    @IBAction func signupButtonTouchUpInside(_ sender: AnyObject) {
        if mode == .login {
            ...
            if self.signupPasswordInputView.textFieldView.text != self.signupPasswordConfirmInputView.textFieldView.text{
                let alertController = UIAlertController(title: "Error", message: "Please enter an email and password.", preferredStyle: .alert)
